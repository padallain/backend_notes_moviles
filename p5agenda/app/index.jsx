...
export default function Index() {
  ...
  const handlePress = () => {
    ...
    loginbook.value = withTiming(-400, {
      duration: 1200,
      easing: Easing.bezier(0.5, -0.5, 0.25, 1),
    });
    ...
    // Animar la aparición de los inputs
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Animated.View style={[styles.input1, inputAnimatedStyle]}>
          <TextInput
        ...
        <Animated.View style={[styles.input2, inputAnimatedStyle]}>
          <TextInput
        ...
        <Animated.Image
          ...
          style={[styles.fieldlogin1, BookAnim]}
        />
        <Animated.Image
          source={require("../assets/images/Login/Field.png")}
          style={[styles.fieldlogin2, BookAnim]}
        />
      </View>
    </Pressable>
  );
